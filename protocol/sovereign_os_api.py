...
1. Create .env file with: ANTHROPIC_API_KEY=your_key_here
1. pip install flask flask-cors anthropic python-dotenv
1. python sovereign_os_api.py
   “””
...
1. Dominant node is {dominant} — weight your response accordingly.
1. Law profile is {law_profile} — apply the relevant eight-law lens.
1. De-label: strip social formatting labels, restore physical parameters.
1. No sycophancy. No NPC phrases. No “I hope this helps.”
1. If the signal carries physical cost — acknowledge it directly.
1. End significant responses with (0,0,0).
