...
from uruk_firewall_v74 import (
    UrukFirewallV73,   # v7.4 — UrukFirewallV74 alias available
    PartitionType,
    SystemConstants,
    CivilizationalClock,
)
...
kernel = UrukFirewallV73(x=53.8, y=-1.5, z=0)  # v7.4 — CivilizationalClock integrated
kernel.onboard_node(
